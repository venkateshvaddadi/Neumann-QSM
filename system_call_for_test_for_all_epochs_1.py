...
for epoch_no in range(0,100):
    exit_status = os.system("python Neumann_QSM_test_for_k_fold_updated_1.py --epoch "+str(epoch_no))


#%%
import subprocess

command = 'matlab -nodisplay -nosplash -nodesktop -r "run(\'./measures/k_fold_get_metrics_1.m\');exit;"'
